...
### Linux/macOS
```sh
bash <(curl -Ls https://raw.githubusercontent.com/iKeilo/s-uiR/main/install.sh)
```

### Alpine Linux
```sh
bash <(curl -Ls https://raw.githubusercontent.com/iKeilo/s-uiR/main/install_ap.sh)
```

### Windows
1. 从 [GitHub Releases](https://github.com/iKeilo/s-uiR/releases/latest) 下载最新 Windows 版本。
2. 解压 ZIP 文件。
...
你也可以从 [GitHub Releases](https://github.com/iKeilo/s-uiR/releases/latest) 获取最新版本安装包。
...
### Linux/macOS
1. 根据你的系统和架构，从 GitHub 获取最新版本 S-UI：[https://github.com/iKeilo/s-uiR/releases/latest](https://github.com/iKeilo/s-uiR/releases/latest)
2. **可选：** 获取最新版 `s-ui.sh`：[https://raw.githubusercontent.com/iKeilo/s-uiR/main/s-ui.sh](https://raw.githubusercontent.com/iKeilo/s-uiR/main/s-ui.sh)
...
### Windows
1. 从 GitHub 获取最新 Windows 版本：[https://github.com/iKeilo/s-uiR/releases/latest](https://github.com/iKeilo/s-uiR/releases/latest)
